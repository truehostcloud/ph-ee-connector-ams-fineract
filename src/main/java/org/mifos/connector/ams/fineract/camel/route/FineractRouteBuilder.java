    ...
    public void configure() throws Exception {
        from("direct:transfer-validation-base")
                ...
                .process(exchange -> {
                    ...
                    exchange.setProperty(ACCT_HOLDING_INSTITUTION_ID_VARIABLE_NAME, exchange.getProperty(ACCT_HOLDING_INSTITUTION_ID_VARIABLE_NAME));
        ...
        from("direct:transfer-validation")
                ...
                .setBody(exchange -> {
                    ...
                    if(exchange.getProperty(CHANNEL_REQUEST)  != null){
                        ...
                        verificationRequestDTO = FineractRequestDto.fromChannelRequest(channelRequest,exchange.getProperty(TRANSACTION_ID, String.class) );
                    } else {
        ...
        from("direct:transfer-settlement-base")
            ...
            .process(exchange -> {
                ...
                Boolean transactionFailed =
                    exchange.getProperty(TRANSACTION_FAILED, Boolean.class);
