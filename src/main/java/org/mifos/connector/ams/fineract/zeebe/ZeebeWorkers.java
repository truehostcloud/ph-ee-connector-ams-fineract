...
public class ZeebeWorkers {
    ...
    public ZeebeWorkers(ZeebeClient zeebeClient, CamelContext camelContext,
    ...
    private void checkOperationResultAndSetVariables(String operationName,  Exchange ex, Map<String, Object>   variables){
        ...
        if(isOperationFailed == null || isOperationFailed) {
            ...
            variables.put(ERROR_DESCRIPTION, ConnectionUtils.parseErrorDescriptionFromJsonPayload(
