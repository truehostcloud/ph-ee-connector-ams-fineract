...
public class ZeebeVariables {
  ...
  public static final String FINERACT_AMS_ZEEBEE_VALIDATION_WORKER_NAME =
      "transfer-validation-fineract";
  public static final String FINERACT_AMS_ZEEBEE_SETTLEMENT_WORKER_NAME =
      "transfer-settlement-fineract";
}
